...
cleaned_data as (
    select
        ...
        case 
            ...
            when claim_amount <= {{ var('high_value_claim_threshold') }} then 'Moderate'
        ...
        case when claim_amount > {{ var('high_value_claim_threshold') }} then true else false end as is_high_value,
